...
There is **no remote service** and no player/server interaction in this challenge.

| Side | Details |
|---|---|
| Server | None |
| Player input | Offline analysis only |
| Goal | Recover the image from the provided `zip2john` line |
